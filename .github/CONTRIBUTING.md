...
1. View the [Issues](https://github.com/billbatista/Datadog.Trace.MassTransit/issues) page to see a To-Do list of things to be implemented.
...
- Projects uses .editorconfig to produce style warnings. Please fix all warnings in any code you submit.
